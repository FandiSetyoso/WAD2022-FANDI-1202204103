        ...
        <div class="container">
            <div class="collapse navbar-collapse">
                <div class="navbar-nav gap-3">
                    ...
                    <a href="addpage.html" class="nav-link">Mycar</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <section id="home">
        <div class="container" >
            <div class="d-flex gap-5 justify-content-center align-items-center" style="margin-top: 200px; margin-bottom: 200px;">
                <div>
                    <h1>Selamat Datang di<br>Show Room Fandi</h1>
                    <p class="mt-3" style="color: #757575;">Showroom mobil mewah terbesar <br> serta terlengkap di Indonesia</p>
                    <a href="AddItem.php" class="button btn-primary">My car</a>
                    <div class="d-flex align-items-center gap-5 mt-5">
                        <img src="\MODUL3 FANDI\logo-ead.png" alt="...">
                        <p style="margin-top: 20px; font-size:14px;">Fandi_1202204103</p>
                    </div>
                </div>
                <img src="\MODUL3 FANDI\Image.png" alt="...">
            </div>
        </div>
    </section>
</body>
