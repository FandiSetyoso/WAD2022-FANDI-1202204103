  ...
  <section id='form'>
    <div class="container">
      ...
      <form action="Add.php" method="POST" enctype="multipart/form-data">
        ...
        <span class="d-flex">
          <input type="radio" name="status" value="Lunas" style="width: 15px; height: 15px; margin-right:10px;">
          <label for="lunas" style="margin-top: 15px; margin-right:10px;">Lunas</label>
          <input type="radio" name="status" value="Belum Lunas" style="width: 15px; height: 15px; margin-right:10px;">
