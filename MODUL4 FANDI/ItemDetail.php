...
$sql = "SELECT * FROM showroom_fandi_table WHERE id_mobil = $id";
    ...
    <nav class="navbar navbar-expand-lg bg-primary sticky-top">
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-link" style="color: white;" href="MyItem.php">My Car</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        while ($getDetail = mysqli_fetch_array($result)) {
            echo "
                    ...
                    <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                        <img src='" . $getDetail["foto_mobil"] . "' alt='foto_mobil'>
                            <form action='Edit.php?id=". $getDetail['id_mobil'] ."' method='POST' enctype='multipart/form-data'>
                            ...
                            <div class='input-group mb-3'>
                                <input type='text' class='form-control' id='inputGroupFile01' value='" . $getDetail["foto_mobil"] . "' >
                            </div>
